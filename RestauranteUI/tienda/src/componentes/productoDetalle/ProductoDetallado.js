...
class ProductoDetallado extends Component { 
  ...
  componentWillReceiveProps(props){
    const howManyInTheCar = tengoEsteProductoEnElCarrito(props.detalleProducto._id,props.carrito.productos);
        ...
        <div>
         { this.props.viewActive === Views.DETAILSCART ?
          ...
          <div className="position-relative py-md-3 justify-content-center container-detail-product row px-3 ">
            <div className="col-auto col-md-8 col-lg-6 col-xl-6 container-web-card">
              <div className="row align-items-center justify-content-center pt-3 pt-md-2">
                ...
                <div className="col-12 text-center align-items-center py-1 px-0">
                    <Button className="btn-back px-2 float-left " onClick={()=> this.onBack()}>
              ...
              <div className="row py-3 justify-content-center container-web d-none d-md-flex">
                ...
                <div className="col-6">
                  <div className="row justify-content-center  py-3">
                      <div className="col-auto">
                        <span className="lead label-detail">{this.props.detalleProducto.detalle}</span>
                      </div>
                    </div>
                    <Row className="justify-content-center py-2 ">
                      <Col className="text-center">
                          <span className="price-label">${this.props.detalleProducto.precio}</span>
                      </Col>
                    </Row>
                  </div>
              </div>
                ...
                <div className="col-12">
                  <div className="row justify-content-center">
                    ...
                    <div className="col-7 px-0">
                      <Button className="btn-add-card py-2" onClick={()=> this.onClickAddTocart()}>
                      <img src={AddPlusIcon} alt="Cart" className="float-left" />
                        Agregar al carrito
                      </Button>
                    </div>
                  </div>
                ...
                <div className="col-12">
                  <div className="row justify-content-center">
                    <div className="col-10">
                      <Button className="btn-add-card py-2" onClick={()=> this.onClickAddTocart()}>Agregar al carrito</Button>
                    </div>
                  </div>
                </div>
              </div>
